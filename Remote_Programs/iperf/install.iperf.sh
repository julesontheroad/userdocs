...
#
wget -qO ~/bin/iperf3 https://iperf.fr/download/ubuntu/iperf3_3.1.3 && chmod +x ~/bin/iperf3
...
echo
echo 'iperf3 -p '"$port"' -c '"$(curl -s icanhazip.com)"''
echo 'iperf3 -p '"$port"' -c '"$(curl -s icanhazip.com)"' -R'
echo 'iperf3 -p '"$port"' -c '"$(curl -s icanhazip.com)"' -R -P 10'
echo 'iperf3 -p '"$port"' -c '"$(curl -s icanhazip.com)"' -R -u'
echo 'iperf3 -p '"$port"' -c '"$(curl -s icanhazip.com)"' -R -P 10 -u'
echo
#
iperf3 -p $port -s